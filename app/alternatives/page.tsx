...
export const metadata = {
  title: 'AI Tool Alternatives | The AI Prism',
  description:
    'Cheaper, free, and BYOK alternatives to popular AI tools — tested and ranked. Stop overpaying for software you can replace.',
  alternates: { canonical: 'https://theaiprism.com/alternatives' },
};

export default function AlternativesPage() {
  const posts = getAllMDXFiles('alternatives');
    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <header className="mb-12 text-center">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Cheaper, free, and BYOK swaps for the AI tools you already pay for.
        </p>
      </header>
      ...
      {posts.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-600 dark:text-gray-400">
            No alternatives roundups yet. Check back soon!
          </p>
        </div>
      )}
    </div>
